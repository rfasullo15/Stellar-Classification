...
7/18/2018: Class created: Generates a file explorer to select the data files you want for continuum rectification
...
class rfiles:
    ...
    def __init__(self,parent):
        ...
        self.root.title("File Selection for Continuum Rectification")
